...
namespace CertControlSystem.Controllers
{
    public class ClientsController : Controller
    {
        ...
        public ClientsController(CertDbContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstName,LastName,Email,PhoneNumber,CreatedAt")] Client client)
        {
            if (id != client.Id)
            {
                return NotFound();
